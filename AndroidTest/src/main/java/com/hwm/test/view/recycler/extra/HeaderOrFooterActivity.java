package com.hwm.test.view.recycler.extra;
...
import com.hwm.test.view.recycler.extra.adapter.CartoonAdapter;
import com.hwm.test.view.recycler.extra.block.FooterBlock;
import com.hwm.test.view.recycler.extra.block.HeaderBlock;
import com.hwm.test.view.recycler.extra.data.CartoonDataManager;
...
public class HeaderOrFooterActivity extends BaseActivity implements ResponseCallback {
    ...
    private void setWaterFallRcv() {
        ...
        List<TestDataBean.DataEntity.ObjectListEntity> mData = new ArrayList<>();// 先放一个空的list
