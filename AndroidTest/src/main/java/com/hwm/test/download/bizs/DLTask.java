...
import static com.hwm.test.download.bizs.DLCons.Base.DEFAULT_TIMEOUT;
import static com.hwm.test.download.bizs.DLCons.Base.LENGTH_PER_THREAD;
import static com.hwm.test.download.bizs.DLCons.Base.MAX_REDIRECTS;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_MOVED_PERM;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_MOVED_TEMP;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_NOT_MODIFIED;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_OK;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_PARTIAL;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_SEE_OTHER;
import static com.hwm.test.download.bizs.DLCons.Code.HTTP_TEMP_REDIRECT;
import static com.hwm.test.download.bizs.DLError.ERROR_OPEN_CONNECT;
